...
- Tasks:
    ...
    - Import data from data.csv into the newly created table.
...
Upon completion of the tasks, the deliverable should consist of the Python code used for the evaluation.
